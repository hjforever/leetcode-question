...
public class Q452YongZuiShaoShuLiangDeJianYinBaoQiQiu {
    public static void main(String[] args) {
        Solution solution = new Q452YongZuiShaoShuLiangDeJianYinBaoQiQiu().new Solution();
    }
