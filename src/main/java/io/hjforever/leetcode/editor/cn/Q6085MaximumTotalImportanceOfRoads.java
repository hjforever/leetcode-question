...
//value can only be used once. The importance of a road is then defined as the sum 
...
//Output: 43
//Explanation: The figure above shows the country and the assigned values of [2,
//4,5,3,1].
...
//Output: 20
//Explanation: The figure above shows the country and the assigned values of [4,
//3,2,5,1].
...
public class Q6085MaximumTotalImportanceOfRoads {
    public static void main(String[] args) {
        Solution solution = new Q6085MaximumTotalImportanceOfRoads().new Solution();
    }
