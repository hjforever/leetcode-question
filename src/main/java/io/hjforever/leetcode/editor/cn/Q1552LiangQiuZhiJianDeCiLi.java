...
// 2 <= m <= position.length 
// 
// Related Topics 数组 二分查找 排序 👍 95 👎 0
...
public class Q1552LiangQiuZhiJianDeCiLi {
    public static void main(String[] args) {
        Solution solution = new Q1552LiangQiuZhiJianDeCiLi().new Solution();
    }
