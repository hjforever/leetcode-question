...
//be either 'L', 'R', or 'S' denoting whether the iᵗʰ car is moving towards the 
//left, towards the right, or staying at its current point respectively. Each moving 
...
public class Q2211CountCollisionsOnARoad {
    public static void main(String[] args) {
        Solution solution = new Q2211CountCollisionsOnARoad().new Solution();
    }
