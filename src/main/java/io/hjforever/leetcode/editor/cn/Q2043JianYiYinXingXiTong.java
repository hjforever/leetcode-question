...
public class Q2043JianYiYinXingXiTong {
    public static void main(String[] args) {

        //Solution solution = new Q2043JianYiYinXingXiTong().new Solution();
    }
    ...
    class Bank {
        ...
        public boolean transfer(int account1, int account2, long money) {
            boolean validate = validateAccount(account1) && validateAccount(account2);
        ...
        public boolean deposit(int account, long money) {
            boolean validate = validateAccount(account);
            if (!validate) return false;
