...
// 
// Related Topics 双指针 字符串 👍 258 👎 0


package io.hjforever.leetcode.editor.cn;

public class Q165BiJiaoBanBenHao {
    public static void main(String[] args) {
        Solution solution = new Q165BiJiaoBanBenHao().new Solution();
    }
    ...
    class Solution {
        public int compareVersion(String version1, String version2) {
            ...
            int len = v1Array.length > v2Array.length ? v2Array.length : v1Array.length;
            for (int i = 0; i < len; i++) {
            ...
            for (int i = len; i < Math.max(v1Array.length, v2Array.length); i++) {
