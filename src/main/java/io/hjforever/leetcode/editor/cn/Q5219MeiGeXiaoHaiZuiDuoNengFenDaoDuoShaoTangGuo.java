...
public class Q5219MeiGeXiaoHaiZuiDuoNengFenDaoDuoShaoTangGuo {
    public static void main(String[] args) {
        Solution solution = new Q5219MeiGeXiaoHaiZuiDuoNengFenDaoDuoShaoTangGuo().new Solution();
    }
    ...
    class Solution {
        ...
        public long calc(int[] cand, long k) {
            long sum = 0;
