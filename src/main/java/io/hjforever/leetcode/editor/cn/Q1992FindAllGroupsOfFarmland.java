...
// 
// Related Topics 深度优先搜索 广度优先搜索 数组 矩阵 👍 10 👎 0
...
public class Q1992FindAllGroupsOfFarmland {
    public static void main(String[] args) {
        Solution solution = new Q1992FindAllGroupsOfFarmland().new Solution();
    }

    //leetcode submit region begin(Prohibit modification and deletion)
    class Solution {
        public int[][] findFarmland(int[][] land) {
            //因题意农场都为矩形,直接遍历，左上和右下节点
            int r = land.length;
            int c = land[0].length;
