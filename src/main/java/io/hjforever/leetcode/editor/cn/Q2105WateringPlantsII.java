...
//water it. Otherwise, they first refill their can (instantaneously) then water the 
//plant. 
...
// 
// Related Topics 数组 双指针 模拟 👍 3 👎 0


package io.hjforever.leetcode.editor.cn;

public class Q2105WateringPlantsII {
    public static void main(String[] args) {
        Solution solution = new Q2105WateringPlantsII().new Solution();
    }
